<template>
  <div class="index-page">
    <header>
      <div class="logo">
        <h1>
          <a href="https://disneyworld.disney.go.com/" target="_blank" rel="noopener">
            <img src="@/assets/images/logo.jpg" alt="Disney logo" />
          </a>
        </h1>
      </div>
      <div class="list">
        <ul>
          ...
          <li>
            <a href="./乐园资讯.html">乐园资讯</a>
          </li>
          <li>
            <a href="./相关影视.html">相关影视</a>
          </li>
          <li>
      ...
      <div class="search">
        ...
        <a href="./注册.html" target="_blank" rel="noopener">
          <button>注册</button>
        </a>
        <a href="./登录.html" target="_blank" rel="noopener">
          <button>登录</button>
        </a>
      </div>
    </header>
